...
extern char const __attribute__((weak)) symbol_PRIVATE_pax_font_sky[] asm("PRIVATE_pax_font_sky");
extern char const __attribute__((weak)) symbol_PRIVATE_pax_font_sky_mono[] asm("PRIVATE_pax_font_sky_mono");
extern char const __attribute__((weak)) symbol_PRIVATE_pax_font_marker[] asm("PRIVATE_pax_font_marker");
extern char const __attribute__((weak)) symbol_PRIVATE_pax_font_saira_condensed[] asm("PRIVATE_pax_font_saira_condensed");
extern char const __attribute__((weak)) symbol_PRIVATE_pax_font_saira_regular[] asm("PRIVATE_pax_font_saira_regular");
...
extern char const __attribute__((weak)) symbol_pax_buf_get_widthf[] asm("pax_buf_get_widthf");
extern char const __attribute__((weak)) symbol_pax_buf_get_heightf[] asm("pax_buf_get_heightf");
...
extern char const __attribute__((weak)) symbol_pax_shader_font_bmp_hi_pal[] asm("pax_shader_font_bmp_hi_pal");
extern char const __attribute__((weak)) symbol_pax_shader_font_bmp_hi[] asm("pax_shader_font_bmp_hi");
extern char const __attribute__((weak)) symbol_pax_shader_font_bmp_hi_aa[] asm("pax_shader_font_bmp_hi_aa");
...
extern char const __attribute__((weak)) symbol_pax_round_shape_uniform[] asm("pax_round_shape_uniform");
extern char const __attribute__((weak)) symbol_pax_round_shape[] asm("pax_round_shape");
extern char const __attribute__((weak)) symbol_pax_triang_complete[] asm("pax_triang_complete");
...
kbelf_builtin_lib const app_elf_lib_pax_gfx = {
    .path        = "libpax-gfx.so",
    .symbols_len = 125,
    .symbols     = symbols,
};

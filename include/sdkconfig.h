...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partition_tables/16M.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partition_tables/16M.csv"
...
#define CONFIG_ESP_HOSTED_GPIO_SLAVE_RESET_SLAVE 
